...
Subsystem("DriveTrain")
{
	...
	casterPiston = RobotMap::driveTrainCasterPiston;
...
{	
	if(driveFront) {
		...
		if(fabs(RLSetPoint + RLOffset - frontRightPos->GetAverageVoltage()) < 1.25 || fabs(RLSetPoint + FROffset - frontRightPos->GetAverageVoltage()) > 3.75)
		{
...
{
	SetSteerSetpoint(3.0, 1.5, .75, 4.5);
	SetDriveSpeed(0,0,0,0);
}
