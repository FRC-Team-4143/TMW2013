...
void Robot::RobotInit() {
	...
	autoChooser->AddObject("5. Left: Shoot 3 Block", new Shoot3DriveBackOverDiscs(true));
	autoChooser->AddObject("6. Right: Shoot 3 Block", new Shoot3DriveBackOverDiscs(false));
