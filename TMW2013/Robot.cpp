...
#include "Commands/Shoot3CenterPickup4.h"
...
void Robot::RobotInit() {
	...
	autoChooser->AddObject("Shoot3CornerPickup2", new Shoot3CornerPickup2(true));
	autoChooser->AddObject("Shoot3RightCornerPickup2", new Shoot3CornerPickup2(false));
	autoChooser->AddObject("Shoot3CenterPickup4", new Shoot3CenterPickup4);
