...
public:
	...
	static CANJaguar* driveTrainFrontRightDrive;
	static CANJaguar* driveTrainFrontLeftDrive;
	static CANJaguar* driveTrainRearRightDrive;
	static CANJaguar* driveTrainRearleftDrive;
