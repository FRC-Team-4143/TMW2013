...
OI::OI() {
	...
	startStopShooter = new JoystickButton(driverJoystick, 9);
	startStopShooter->WhenPressed(new ShooterAtDefinedOutput());
	joystickButton2 = new JoystickButton(driverJoystick, 2);
	joystickButton2->WhileHeld(new PivotDrive());
	...
	SmartDashboard::PutData("PivotDrive", new PivotDrive());
	SmartDashboard::PutData("SetWheelOffsets", new SetWheelOffsets());
	SmartDashboard::PutData("TurnRobot", new TurnRobot());
	SmartDashboard::PutData("RandomDriving", new RandomDriving());
	SmartDashboard::PutData("Drive", new Drive());
	SmartDashboard::PutData("TurnWheels", new TurnWheels());
