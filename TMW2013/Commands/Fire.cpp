...
void Fire::Execute() {
	...
	if(TimeSinceInitialized() > .1 && TimeSinceInitialized() < .25)
		Robot::shooter->SetFireFlag(true);
}
// Make this return true when this Command no longer needs to run execute()
bool Fire::IsFinished() {
	return Robot::shooter->GetTriggerStopFlag() || notready || TimeSinceInitialized() > 3.3;
}
// Called once after isFinished returns true
void Fire::End() {
	Robot::shooter->trigger->Set(0);
	Robot::shooter->SetFireTimer();
	Robot::shooter->SetTriggerStopFlag(false);
}
