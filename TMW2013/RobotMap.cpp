...
void RobotMap::init() {
	...
	driveTrainFrontRightPos = new AnalogChannelVolt(1, FRP, true, 1);
	...
	driveTrainFrontLeftPos = new AnalogChannelVolt(1, FLP, true, 1);
	...
	driveTrainRearRightPos = new AnalogChannelVolt(1, RRP, true, 1);
	...
	driveTrainRearLeftPos = new AnalogChannelVolt(1, RLP, true, 1);
