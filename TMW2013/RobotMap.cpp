...
void RobotMap::init() {
	...
	climberAngle = new PIDController(0.005, 0.001, 0.0,/* F: 0.0, */ climberAnglePos, climberAngleLeft, 0.02);
	lw->AddActuator("Climber", "Angle", climberAngle);
	climberAngle->SetContinuous(false); climberAngle->SetAbsoluteTolerance(0.2); 
